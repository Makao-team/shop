    ...
    class validateUser {
        ...
        void existsByEmail_성공_인증_성공() {
            ...
            try (var d = mockStatic(StringEncoder.class)) {
                ...
                assertThat(userService.validateUser("email", "password123!")).isTrue();
            }
        }
        ...
        void existsByEmail_성공_인증_실패() {
            ...
            try (var d = mockStatic(StringEncoder.class)) {
                ...
                assertThat(userService.validateUser("email", "password123!")).isFalse();
            }
        }
        ...
        void existsByEmail_이메일_없음_실패() {
            ...
            var exception = assertThrows(CommonExceptionImpl.class, () -> userService.validateUser("email", "password123!"));
